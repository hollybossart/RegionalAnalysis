...
ukroblast$anxrisk <- "Low"
ukroblast$anxrisk[anx_most_cluster] <- "High"
ukroblast$anxrisk[anx_second_cluster] <- "Medium"

ggplot(data = ukroblast, aes(fill = anxrisk)) +
  geom_sf() +
  labs(title = "Clusters, Anxiety Disorders",
       fill = "Risk Level") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank())
```
...
ukroblast$iedrisk <- "Low"
ukroblast$iedrisk[ied_most_cluster] <- "High"
# ukroblast$iedrisk[any_second_cluster] <- "Medium"

ggplot(data = ukroblast, aes(fill = iedrisk)) +
  geom_sf() +
  labs(title = "Clusters, IED Disorders",
       fill = "Risk Level") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank())
```
...
ukroblast$affrisk <- "Low"
ukroblast$affrisk[aff_most_cluster] <- "High"
ukroblast$affrisk[aff_second_cluster] <- "Medium"

ggplot(data = ukroblast, aes(fill = affrisk)) +
  geom_sf() +
  labs(title = "Clusters, Affective Disorders",
       fill = "Risk Level") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank())
```
...
ukroblast$alcrisk <- "Low"
ukroblast$alcrisk[alc_most_cluster] <- "High"
# ukroblast$affrisk[aff_second_cluster] <- "Medium"

ggplot(data = ukroblast, aes(fill = alcrisk)) +
  geom_sf() +
  labs(title = "Clusters, Alcohol Disorders",
       fill = "Risk Level") +
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank())
```
